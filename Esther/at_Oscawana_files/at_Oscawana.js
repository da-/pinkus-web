...
{return IWCreatePhotocast("file://localhost/Volumes/Leon%20Thumb%20Drive/Esther/at_Oscawana_files/rss.xml",true,true);}
...
IWLayoutPhotoGrid('id3',new IWPhotoGridLayout(3,new IWSize(191,191),new IWSize(191,34),new IWSize(229,240),27,27,0,new IWSize(0,0)),new IWStrokeParts([{rect:new IWRect(-2,-1,1,193),url:'at_Oscawana_files/stroke.png'},{rect:new IWRect(-2,-2,1,1),url:'at_Oscawana_files/stroke_1.png'},{rect:new IWRect(-1,-2,193,1),url:'at_Oscawana_files/stroke_2.png'},{rect:new IWRect(192,-2,1,1),url:'at_Oscawana_files/stroke_3.png'},{rect:new IWRect(192,-1,1,193),url:'at_Oscawana_files/stroke_4.png'},{rect:new IWRect(192,192,1,1),url:'at_Oscawana_files/stroke_5.png'},{rect:new IWRect(-1,192,193,1),url:'at_Oscawana_files/stroke_6.png'},{rect:new IWRect(-2,192,1,1),url:'at_Oscawana_files/stroke_7.png'}],new IWSize(191,191)),imageStream,range,null,null,1.000000,{backgroundColor:'#000000',reflectionHeight:100,reflectionOffset:2,captionHeight:100,fullScreen:0,transitionIndex:2},'Media/slideshow.html','widget1','widget2','widget3')});}
...
loadMozillaCSS('at_Oscawana_files/at_OscawanaMoz.css')
